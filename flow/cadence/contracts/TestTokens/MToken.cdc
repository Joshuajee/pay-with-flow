...
pub contract MToken: FungibleToken {

    /// Total supply of MTokens in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @MToken.Vault
        ...
        destroy() {
            if self.balance > 0.0 {
                MToken.totalSupply = MToken.totalSupply - self.balance
            }
        }

        /// The way of getting all the Metadata Views implemented by MToken
        ///
        ...
        /// The way of getting a Metadata View out of the MToken
        ///
            ...
            switch view {
                ...
                case Type<FungibleTokenMetadataViews.FTVaultData>():
                    return FungibleTokenMetadataViews.FTVaultData(
                        storagePath: MToken.VaultStoragePath,
                        receiverPath: MToken.ReceiverPublicPath,
                        metadataPath: MToken.VaultPublicPath,
                        providerPath: /private/MTokenVault,
                        receiverLinkedType: Type<&MToken.Vault{FungibleToken.Receiver}>(),
                        metadataLinkedType: Type<&MToken.Vault{FungibleToken.Balance, MetadataViews.Resolver}>(),
                        providerLinkedType: Type<&MToken.Vault{FungibleToken.Provider}>(),
                        createEmptyVaultFunction: (fun (): @MToken.Vault {
                            return <-MToken.createEmptyVault()
                        })
                    )
            }
            return nil
    ...
    pub resource Minter {
        ...
        ///
        pub fun mintTokens(amount: UFix64): @MToken.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            MToken.totalSupply = MToken.totalSupply + amount
    ...
    init() {
        ...
        self.VaultStoragePath = /storage/MTokenVault
        self.VaultPublicPath = /public/MTokenMetadata
        self.ReceiverPublicPath = /public/MTokenReceiver
        self.AdminStoragePath = /storage/MTokenAdmin
        ...
        self.account.link<&MToken.Vault{FungibleToken.Balance}>(
