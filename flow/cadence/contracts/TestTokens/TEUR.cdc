...
pub contract TEUR: FungibleToken {
    ...
    // Total supply of TEUR in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        destroy() {
            TEUR.totalSupply = TEUR.totalSupply - self.balance
        }
    }
    ...
    //
    pub fun createEmptyVault(): @TEUR.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @TEUR.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
            }
            TEUR.totalSupply = TEUR.totalSupply + amount
    ...
    pub resource Administrator {
        ...
        // transactions/TEUR/minter/setup_minter_account.cdc
    ...
    //     self.AdminStoragePath = /storage/TEURAdmin
    //     self.MinterProxyPublicPath = /public/TEURMinterProxy
    //     self.MinterProxyStoragePath = /storage/TEURMinterProxy
