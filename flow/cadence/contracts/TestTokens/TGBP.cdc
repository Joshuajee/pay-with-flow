...
pub contract TGBP: FungibleToken {
    ...
    // Total supply of TGBP in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        destroy() {
            TGBP.totalSupply = TGBP.totalSupply - self.balance
        }
    }
    ...
    //
    pub fun createEmptyVault(): @TGBP.Vault {
        return <-create Vault(balance: 0.0)
    }

    pub fun mintTokens(): @TGBP.Vault {
        TGBP.totalSupply = TGBP.totalSupply + 1000.0 
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @TGBP.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
            }
            TGBP.totalSupply = TGBP.totalSupply + amount
    ...
    pub resource Administrator {
        ...
        // transactions/TGBP/minter/setup_minter_account.cdc
    ...
    //     self.AdminStoragePath = /storage/TGBPAdmin
    //     self.MinterProxyPublicPath = /public/TGBPMinterProxy
    //     self.MinterProxyStoragePath = /storage/TGBPMinterProxy
