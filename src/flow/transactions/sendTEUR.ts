...
const sendTEUR = async (recepient: string, tx_ref: string, amount: number, callback?: () => void, errCallback?: () => void) => {
    const cadence = `
        ...
        transaction(recepient: Address, tx_ref: String, amount: UFix64){
            ...
            prepare(signer: AuthAccount){
                ...
                let sender = signer.borrow<&TEUR.Vault>(from: /storage/teurVault)
                ...
                receiver.depositTEUR(from: <- tempVault, tx_ref: tx_ref)
